...
<body>
  ...
  <div class="container my-4">
      ...
      <tbody>
        <?php 
          ...
          while($row = mysqli_fetch_assoc($result)){
            ...
            <td> <button class='edit btn btn-sm btn-primary' ><a href= 'https://forms.gle/Tv4S2aCmvrT1VJy29'>Feedback</a></button>  </td>
          </tr>";
        } 
          ?>
    ...
    <button class='edit btn btn-sm btn-primary' ><a href='https://forms.gle/LSbgfaJAyue5SWFv8' >Aggregate feedback</a></button>
    </div>
  <hr>
    </body>
    </html>
